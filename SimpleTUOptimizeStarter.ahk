...
BGEffects := "none|Virulence|Heal all 2|Enhance all Rally 2|Enfeeble all X|Enhance all S X|Evolve n S1 S2|Heal all X|Mortar X|Protect all X|Rally all X|Siege all X|Strike all X|Weaken all X|Brigade|Bloodlust X|Counterflux|Divert|EnduringRage|Fortification|Heroism|Metamorphosis|Revenge X|TurningTides|ZealotsPreservation"
...
Gui, Add, ComboBox, vEffect xs Choose1 section, %BGEffects%
...
Gui, Show,, Simple Tyrant Unleashed Optimize Starter v2.21.0
return  
